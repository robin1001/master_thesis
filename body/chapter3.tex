...
实验中，使用5隐层的DNN，DNN隐层节点为1024，DNN使用特征为40维Fbank特征，左右各拼5帧以更好的利用上下文信息，所以输入特征共440维。
...
根据Google\ucite{sak2014long, sak2014long_lvsr}，LSTM中使用2层的LSTMP，Cell为1024，Projection为512。
