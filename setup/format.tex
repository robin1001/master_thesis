...
\addtolength{\headsep}{-1.2mm}       %页眉位置
\addtolength{\footskip}{4.2mm}         %页脚位置
...
\newcommand{\xiaosi}{\fontsize{12pt}{13.5pt}\selectfont}    % 小四, 1.?倍行距
%\newcommand{\xiaosi}{\fontsize{12pt}{12pt}\selectfont}    % 小四, 1.0倍行距
\newcommand{\dawuhao}{\fontsize{11pt}{11pt}\selectfont}    % 大五号, 单倍行距
\newcommand{\wuhao}{\fontsize{10.5pt}{10.5pt}\selectfont}    % 五号, 单倍行距
\newcommand{\xiaowu}{\fontsize{9pt}{14pt}\selectfont}		% 小五号
...
\titlespacing{\chapter}{0pt}{-6mm}{1.6em}
...
\fancyhead[CE]{\xiaowu{西北工业大学硕士学位论文}}
...
% 调整列表环境的垂直间距
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% xx comment: item & enumerate
\setitemize{leftmargin=3em,itemsep=0em,partopsep=0em,parsep=0em,topsep=-0em}
\setenumerate{leftmargin=3.3em,itemsep=0em,partopsep=0em,parsep=0em,topsep=0em}
...
\lstset {
	...
	commentstyle=\ttfamily\wuhao,
	%basicstyle=\droidmono\footnotesize,
	...
	xrightmargin=10pt,
	language=nesc,
	frame=tb, % 'single' for box
	numbers=left,
	breaklines,
	belowcaptionskip=10.5pt, % caption line space
