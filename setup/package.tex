...
\setlength{\headheight}{18pt} %0.7cm
\setlength{\headsep}{20pt} %0.6cm
\setlength{\textheight}{683pt} %24cm

\usepackage{titlesec}               % 控制标题的宏包
\usepackage{titletoc}                   % 控制目录的宏包
\usepackage{fontspec}
\usepackage{fancyhdr}                   % fancyhdr宏包 页眉和页脚的相关定义
\usepackage{color, colortbl}          % 支持彩色
...
%\usepackage{txfonts} % the font in math environment may be affected by this package. Commentting it out is better.
...
%\usepackage{multicol}
\usepackage{pifont}
\newcommand{\algorithmiclastcon}{\textbf{Termination:}}
